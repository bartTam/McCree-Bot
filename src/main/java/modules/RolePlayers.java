...
public class RolePlayers extends JToggleButton implements Modular{

	private static final String INN_NAME = "Stormy Inn";
	private static final URL INN_URL_JAR = RolePlayers.class.getResource("/resources/Stormy Inn.mp3");
	private static final URL INN_URL = RolePlayers.class.getResource("/Stormy Inn.mp3");
	...
	public RolePlayers(){
		...
		repeatCallback = new SoundCallback(){
			public void soundEnded() {
				System.out.println("Repeating roleplay");
				checkRepeat();
			}
		};
